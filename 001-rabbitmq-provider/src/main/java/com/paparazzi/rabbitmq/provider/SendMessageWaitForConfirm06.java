 ...
 */
public class SendMessageWaitForConfirm06 {

    public static void main(String[] args) throws IOException, TimeoutException, InterruptedException {

        Channel channel = RabbitMQConfig.getChannel();
        String msg = "WaitForConfirm test";
        String exchangeName = "WaitForConfirmExchange";
        String exchangeType = "direct";
        String routingKey = "WaitForConfirmRoutingKey";
        String queueName = "WaitForConfirmQueue";
